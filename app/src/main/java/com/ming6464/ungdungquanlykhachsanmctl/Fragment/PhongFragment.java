...
public class PhongFragment extends Fragment implements RoomsAdapter.IClickItemRooms, View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        img_currentCategory = view.findViewById(R.id.fragPhong_img_currentCategory);
        tv_singleRoom = view.findViewById(R.id.fragPhong_tv_singleRoom);
        tv_doubleRoom = view.findViewById(R.id.fragPhong_tv_doubleRoom);
        tv_vipRoom = view.findViewById(R.id.fragPhong_tv_vipRoom);
    ...
    private void handleFilterCategory() {
        ...
        roomsAdapter.setData(currentListRooms, dao.getListNameCategoryWithRoomId(currentListRooms));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.fragPhong_tv_checkOut:
                ...
                datePickerDialog.show();
                break;
            case R.id.fragPhong_img_currentCategory:
                ...
                break;
            case R.id.fragPhong_tv_singleRoom:
                ...
                break;
            case R.id.fragPhong_tv_doubleRoom:
